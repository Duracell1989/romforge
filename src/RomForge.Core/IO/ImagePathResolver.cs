...
namespace RomForge.Core.IO
{
    public static class ImagePathResolver
    {
        ...
        private static string? Resolve(string imgsBasePath, DatHeader header, int imageNumber, string suffix)
        {
        ...
        /// </summary>
        internal static string BuildRelativeUrlPath(int imageNumber, string suffix) => $"{GetSubfolder(imageNumber)}/{imageNumber}{suffix}.png";
