...
namespace RomForge.UI.Converters
{
    internal static class StatusColors
    {
        ...
        internal static readonly IBrush Verified = new SolidColorBrush(
            Color.FromRgb(0x4C, 0xAF, 0x50)
        );
        internal static readonly IBrush Missing = new SolidColorBrush(
        ...
        internal static readonly IBrush Untrimmed = new SolidColorBrush(
