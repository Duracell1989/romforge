...
namespace RomForge.UI.Converters
{
    internal static class StatusColors
    {
        ...
        internal static readonly IBrush IncorrectlyNamed = new SolidColorBrush(Color.FromRgb(0xFF, 0x98, 0x00));
        internal static readonly IBrush WrongArchiveType = new SolidColorBrush(Color.FromRgb(0x21, 0x96, 0xF3));
