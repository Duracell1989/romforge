    ...
    public partial class LoadedDatVM : VMBase
    {
        ...
        public string StatusSummary
        {
            get
            {
                ...
                var good = Games.Count(g => g.DisplayStatus == RomStatus.Good);
        ...
        private static string ResolveImgsBasePath(string datFilePath)
        {
            ...
            var parentImages = Path.Combine(parentDir, "imgs");
            return Directory.Exists(parentImages) ? parentImages : Path.Combine(datDir, "imgs");
        }
